...
// Advanced particle system with gaming effects

class GamingBackground {
  constructor() {
    this.canvas = document.getElementById("gamingBackground");
...
// Initialize gaming background when DOM is loaded
document.addEventListener("DOMContentLoaded", () => {
  const gamingBg = new GamingBackground();
...
if (window.innerWidth <= 768) {
  ...
  window.addEventListener("load", () => {
    const canvas = document.getElementById("gamingBackground");
    if (canvas) {
